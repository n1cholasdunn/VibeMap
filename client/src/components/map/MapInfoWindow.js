        ...
        <div className="h-30">
            ...
            <div className="flex flex-row flex-wrap">
                {selectedLocation.categories.map(category => (
                    <div
                        className="pr-2 text-md py-1 bg-gradient-to-r from-orange-600 to-gray-400 inline-block text-transparent bg-clip-text "
                    >{category}
                    </div>))}
            </div>
            <div className="flex flex-col align-middle">
                <button
                    ...
                    {likedPlace ? "𝗫 Remove" : "♡ Add to Map"}</button>
                <button
                    className="text-md self-cente hover:text-gray-500 font-normal p-1">More Info +</button>
