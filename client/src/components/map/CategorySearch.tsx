...
const CategorySearch: React.FC<CategorySearchProps> = ({ setSelectedCategories, selectedCategories }) => {

    const handleCategories = (event: any, value: Category[]) => {  //put any for now because event is not being used
