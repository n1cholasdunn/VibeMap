    ...
    return (
        <div className="max-w-sm  h-[200px] bg-white border border-gray-200 rounded-lg shadow-md m-3">
            {!isLoaded ? (
                ...
                <GoogleMap className="rounded-t-lg" mapContainerClassName="map-container" center={center} zoom={mapZoom()}>
                    {directions && (
                        <DirectionsRenderer
            ...
            <div className="pt-5">
                <a href="#">
                    <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 ">{trip.description}</h5>
                </a>
                <a href="#"
